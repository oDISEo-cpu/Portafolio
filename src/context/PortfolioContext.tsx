...
const defaultRepos: Repo[] = [
  {
    id: 1,
    name: "Pagina_Ventas_Tecnologicas",
    description: "Plataforma web para la venta de productos tecnológicos",
    url: "https://github.com/oDISEo-cpu/Pagina_Ventas_Tecnologicas",
    language: "Python",
    stars: 12,
  ...
  },
  {
    ...
    url: "https://github.com/oDISEo-cpu/Sistema_Gestion_Psicologia",
    language: "JavaScript",
    stars: 8,
  ...
  },
  {
    ...
    url: "https://github.com/oDISEo-cpu/serviciosGF",
    language: "TypeScript",
    stars: 5,
